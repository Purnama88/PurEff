...
public class ItemController {
    ...
    @RequestMapping(value = "api/getItem/{id}", method = RequestMethod.GET,
            headers = "Accept=application/json")
    ...
    @RequestMapping(value = "api/addItem", method = RequestMethod.POST,
            headers = "Accept=application/json")
    public ItemEntity addItem(HttpServletRequest httpRequest, @RequestBody ItemEntity item) {
    ...
    @RequestMapping(value = "api/updateItem", method = RequestMethod.PUT,
            headers = "Accept=application/json")
    public ItemEntity updateItem(HttpServletRequest httpRequest, @RequestBody ItemEntity item) {
