...
public class PaymentTypeOutController {
    ...
    @RequestMapping(value = "api/getPaymentTypeOutList/{paymentid}", method = RequestMethod.GET, 
            headers = "Accept=application/json")
    public List<PaymentTypeOutEntity> getPaymentTypeOutList(@PathVariable String paymentid) {
