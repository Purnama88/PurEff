...
public class ItemReturnPurchaseDraftController {
    ...
    @RequestMapping(value = "api/getItemReturnPurchaseDraftList/{id}", method = RequestMethod.GET,
            headers = "Accept=application/json")
    public List<ItemReturnPurchaseDraftEntity> getItemReturnPurchaseDraftList(@PathVariable String id) {
        ReturnPurchaseDraftEntity ad = returnpurchasedraftService.getReturnPurchaseDraft(id);
        
        return itemreturnpurchasedraftService.getItemReturnPurchaseDraftList(ad);
    }
}