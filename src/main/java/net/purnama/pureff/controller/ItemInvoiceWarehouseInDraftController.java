...
public class ItemInvoiceWarehouseInDraftController {
    ...
    @RequestMapping(value = "api/getItemInvoiceWarehouseInDraftList/{id}", method = RequestMethod.GET,
            headers = "Accept=application/json")
    public List<ItemInvoiceWarehouseInDraftEntity> getItemInvoiceWarehouseInDraftList(@PathVariable String id) {
        InvoiceWarehouseInDraftEntity ad = invoicewarehouseindraftService.getInvoiceWarehouseInDraft(id);
        
        return iteminvoicewarehouseindraftService.getItemInvoiceWarehouseInDraftList(ad);
    }
}