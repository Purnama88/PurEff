...
public class PaymentOutInvoicePurchaseDraftController {
    ...
    public ResponseEntity<?> getPaymentOutInvoicePurchaseDraftEntityList(@RequestParam(value="paymentid") String paymentid) {
    ...
    @RequestMapping(value = "api/getPaymentOutInvoicePurchaseDraftEntity",
            method = RequestMethod.GET, 
            headers = "Accept=application/json", params = {"paymentid, invoiceid"})
    public ResponseEntity<?> getPaymentOutInvoicePurchaseDraftEntity(
