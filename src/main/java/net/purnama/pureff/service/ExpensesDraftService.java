...
public class ExpensesDraftService {
    ...
    public List getExpensesDraftList(int itemperpage, int page, String sort,
        ...
        return expensesdraftDao.getExpensesDraftList(itemperpage, page, sort, keyword, user, warehouse);
    }
    
    @Transactional
    public int countExpensesDraftList(String keyword, UserEntity user, WarehouseEntity warehouse){
        return expensesdraftDao.countExpensesDraftList(keyword, user, warehouse);
    }
}
