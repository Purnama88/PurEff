...
public class InvoiceSalesDraftService {
    ...
    public List getInvoiceSalesDraftList(int itemperpage, int page, String sort, 
        ...
        return invoicesalesdraftDao.getInvoiceSalesDraftList(itemperpage, page,
                sort, keyword, user, warehouse);
    }
    
    @Transactional
    public int countInvoiceSalesDraftList(String keyword, UserEntity user, WarehouseEntity warehouse){
        return invoicesalesdraftDao.countInvoiceSalesDraftList(keyword, user, warehouse);
    }
}
