...
public class InvoiceWarehouseOutDraftService {
    ...
    public List getInvoiceWarehouseOutDraftList(int itemperpage, int page, String sort, 
        ...
        return invoicewarehouseindraftDao.getInvoiceWarehouseOutDraftList(itemperpage, page, sort, keyword, user, warehouse);
    }
    
    @Transactional
    public int countInvoiceWarehouseOutDraftList(String keyword, UserEntity user, WarehouseEntity warehouse){
        return invoicewarehouseindraftDao.countInvoiceWarehouseOutDraftList(keyword, user, warehouse);
    }
}